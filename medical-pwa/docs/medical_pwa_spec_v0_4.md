...
| v0.4 ★ | SOP 對齊補強 | §2.3 補入 XABCDE（創傷）與 SAMPLE/OPQRST（非創）欄位；§3.1 補入機動人員角色；§6.2 補入 2 小時輪替提醒與 4 小時強制交班警示 | ✅ 已完成 |
| v0.5 | 作戰核心 | 再評估倒數、後送頁、物資頁、事件頁、交班快照 | ✅ 已完成 |
| v0.5 | 同步與資安 | PIN 鎖、匯出加密、Peer Delta / WebSocket | ✅ 已完成 |
...
*文件版本：v0.5 | 對應程式版本：v0.5.0-alpha | 整合來源：醫療組SOP_20260323.md、shelter_pwa_spec_v2_3.md、security_network_spec_v1.2.md*
