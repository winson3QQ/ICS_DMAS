...
from services.exercise_service import create, get, list_all, set_active, archive
...
from schemas.exercise import ExerciseCreateIn, ExerciseStatusIn, AAREntryIn
...
@router.get("")
def list_exercises(type: Optional[str] = None):
